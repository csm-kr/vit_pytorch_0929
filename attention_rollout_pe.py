...
import math
import cv2
from cos_sim import cosine_simirarity
...
if __name__ == '__main__':
    ...
    for i in range(test_set.__len__()):
        ...
        z_seq, x_ = model.ae(batch_img)
        inductive_bias = (pos_embed + z_seq).squeeze(0)  # remove batch

        cosine_map = cosine_simirarity(inductive_bias.detach().cpu())
